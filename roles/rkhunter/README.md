...
**Note:** Rocky Linux 10 is not supported — rkhunter is not available in EPEL 10.
...
| ------------------ | ------- | ----------------------- |
| `rkhunter_enabled` | `true`  | Enable/disable the role |
...
| `rkhunter:install`   | Package installation     |
| `rkhunter:configure` | Configuration + BTRFS    |
